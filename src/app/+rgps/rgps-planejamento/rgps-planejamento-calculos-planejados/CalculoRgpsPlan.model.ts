...
export class CalculoRgps extends Model {
  ...
  public actions = `
        <div class="btn-group">
          ...
          class="btn bg-color-greenDark txt-color-white btn-xs "title="Cálcular na revisão da vida toda em uma nova aba">&nbsp;<i class="fa fa-calculator fa-1-7x"></i>&nbsp;</a>
        </div>
      `;
...
//     class="btn btn-primary btn-xs" title="Visualizar as simulações do segurado">&nbsp;&nbsp;<i class="fa fa-calculator fa-1-7x">
//     </i>&nbsp;&nbsp;</a>
//   </div>
// `;
