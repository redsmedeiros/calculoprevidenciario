...
export class CalculoRgps extends Model {
  ...
  public actions = `
      <div class="btn-group">
        <a href="#/rgps/rgps-valores-contribuidos/${this.id_segurado}/${this.id}/" class="btn bg-color-blue txt-color-white btn-xs "  title="Editar Salários de Contribuição">&nbsp;<i class="fa fa-money fa-1-7x"></i>&nbsp;</a>
        <a href="#/rgps/rgps-importacao-cnis/${this.id_segurado}/${this.id}/" class="btn bg-color-blueLight txt-color-white btn-xs"  title="Importar Salários de Contribuição do CNIS">&nbsp;<i class="fa fa-arrow-down fa-1-7x"></i>&nbsp;</a>
        <a href="#/rgps/rgps-resultados/${this.id_segurado}/${this.id}/" class="btn btn-success btn-xs "title="Calcular RMI">&nbsp;<i class="fa fa-calculator fa-1-7x"></i>&nbsp;</a>
        <a href="#/rgps/rgps-resultados/${this.id_segurado}/${this.id}/pbc" class="btn bg-color-greenDark txt-color-white btn-xs "title="Calcular RMI - Revisão da Vida Toda">&nbsp;<i class="fa fa-calculator fa-1-7x"></i>&nbsp;</a>
        <a href="#/rgps/rgps-calculos/${this.id_segurado}/${this.id}/edit" id="testee" class="btn btn-warning btn-xs "  title="Editar">&nbsp;<i class="fa fa-edit fa-1-7x"></i>&nbsp;</a>
        <a href="#/rgps/rgps-calculos/${this.id_segurado}/${this.id}/destroy" class="btn btn-danger btn-xs " title="Remover" >&nbsp;<i class="fa fa-times fa-1-7x"></i>&nbsp;</a>
      </div>
  `;
}
