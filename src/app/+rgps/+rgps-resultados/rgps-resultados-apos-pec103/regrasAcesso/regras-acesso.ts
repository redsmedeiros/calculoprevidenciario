...
export class RegrasAcesso {
    ...
    public regraAcessoPontos(pontos, ano, sexo, tempo_contribuicao) {
    ...
    public regraAcessoPontosProf(pontos, ano, sexo, tempo_contribuicao) {
