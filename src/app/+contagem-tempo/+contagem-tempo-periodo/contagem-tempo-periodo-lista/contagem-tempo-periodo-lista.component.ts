...
@Component({
  ...
  selector: 'app-contagem-tempo-periodo-lista',
  templateUrl: './contagem-tempo-periodo-lista.component.html',
})


export class ContagemTempoPeriodoListaComponent implements OnInit {
