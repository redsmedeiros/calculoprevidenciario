...
@Component({
  selector: 'app-contagem-tempo-segurados-form',
  templateUrl: './contagem-tempo-segurados-form.component.html',
  styleUrls: ['./contagem-tempo-segurados-form.component.css']
})
export class ContagemTempoSeguradosFormComponent {
